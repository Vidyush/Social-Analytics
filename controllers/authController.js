...
module.exports.postSignUp = async (req, res) => {
  ...
  var mailOptions = {
    ...
    html:
      ...
      ",<br/> Your account has been sucessfully created.<br/>"
  };
...
module.exports.resetPassword = async (req, res) => {
  ...
  var msg =
    "Hi " +
    user.name +
    "<br/>You are receiving this because you (or someone else) have requested the reset of the password for your account.<br/>" +
    "Please click on the following " +
    '<a href="http://' +
    req.headers.host +
    "/auth/forget/" +
    hash +
    '" target="_blank">link </a>or paste this into your browser to complete the process:<br/><br/>http://' +
    req.headers.host +
    "/auth/forget/" +
    hash +
  ...
  User.update(
    ...
    var mailOptions = {
      ...
      html:
        "Hi " +
        isUser.name +
        ",<br/> Your password has been sucessfully upadated<br/>"
    };
